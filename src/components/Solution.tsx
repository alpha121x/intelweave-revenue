...
const Solution = () => {
  return (
    <section className="relative py-14 sm:py-16 md:py-24 bg-gradient-primary">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <div className="mb-10 sm:mb-12 md:mb-16 text-center">
            ...
            <p className="text-base sm:text-lg text-steel text-pretty">
          ...
          <div className="space-y-4 sm:space-y-6">
            {solutions.map((solution, index) => (
              <motion.div
                ...
                className="group relative p-4 sm:p-6 md:p-8 bg-card border border-border rounded-xl 
              ...
              >
                <div className="flex items-start gap-3 sm:gap-5">
                  ...
                  <div className="flex-grow min-w-0">
                    <h3 className="text-lg sm:text-2xl font-bold mb-2 sm:mb-4 leading-snug">
                      {index + 1}. {solution.title}
                    </h3>

                    {solution.description && (
                      <p className="text-sm sm:text-lg text-steel leading-relaxed whitespace-pre-line text-pretty">
                        {solution.description}
                      </p>
                    )}
                    ...
                    {solution.points && (
                      <ul className="space-y-1.5 sm:space-y-3 mt-3 sm:mt-4">
                        {solution.points.map((point, pointIndex) => (
                          ...
                          >
                            <span className="text-primary mt-1 text-sm sm:text-base">•</span>
                            <span className="text-sm sm:text-lg text-steel text-pretty">
                              {point}
                            </span>
                          </li>
                        ))}
